...
export function AdvancedWidgetBuilder({ bakerId }: AdvancedWidgetBuilderProps) {
  ...
  const generateEmbedCode = () => {
    ...
    return `<iframe 
  src="https://${bakerId}.bakeriq.app/widget/${selectedWidget.id}" 
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex space-x-2">
                        <Input
                          value={`https://${bakerId}.bakeriq.app/widget/${selectedWidget.id}`}
                          readOnly
                          className="font-mono text-sm"
                        />
                        <Button
                          variant="outline"
                          onClick={() => window.open(`https://${bakerId}.bakeriq.app/widget/${selectedWidget.id}`, '_blank')}
