              ...
              <div className="flex flex-wrap gap-2">
                ...
                {baker.socialMedia?.tiktok && (
                  <Button 
                    ...
                    onClick={() => window.open(`https://tiktok.com/@${baker.socialMedia?.tiktok?.replace('@', '')}`, '_blank')}
                  >
                ...
                {baker.socialMedia?.pinterest && (
                  <Button 
                    ...
                    onClick={() => window.open(`https://${baker.socialMedia?.pinterest?.replace('pinterest.com/', '')}`, '_blank')}
                  >
                    <svg className="h-4 w-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0C5.374 0 0 5.374 0 12s5.374 12 12 12c6.626 0 12-5.374 12-12S18.626 0 12 0zm0 19c-.681 0-1.359-.093-2-.268.262-.409.515-.865.696-1.448L11.717 14.8c.194.366.655.608 1.158.608 1.205 0 2.038-1.084 2.038-2.539 0-1.382-.947-2.353-2.492-2.353-1.711 0-2.748 1.15-2.748 2.672 0 .729.29 1.377.908 1.618.1.04.189.004.218-.11l.144-.574c.025-.09.014-.123-.047-.203-.18-.233-.295-.634-.295-1.004 0-.795.597-1.554 1.618-1.554.882 0 1.54.609 1.54 1.459 0 1.006-.44 1.708-.915 1.708-.275 0-.43-.228-.372-.508l.463-1.859c.043-.165.013-.254-.078-.334-.10-.094-.338-.142-.534-.142-.958 0-1.64.85-1.64 2.046 0 .274.044.515.044.515s-.467 1.968-.55 2.324c-.136.599-.041 1.337.014 1.507.033.1.049.134.1.055.072-.114.197-.272.369-.488.368-.554.814-1.455.814-1.455s.145.285.554.285c.747 0 1.255-.678 1.255-1.661 0-1.185-.882-2.033-2.096-2.033z"/>
                    </svg>
                    Pinterest
                  </Button>
                )}
